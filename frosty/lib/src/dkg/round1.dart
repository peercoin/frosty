...
class DkgRound1 {
  ...
  /// the participant and shared with no-one else
  late DkgRound1Secret secret;
  /// The public commitment that must be shared to all other participants
  late DkgPublicCommitment public;
  ...
  DkgRound1({
    ...
    secret = record.$1;
    public = DkgPublicCommitment.fromUnderlying(underlying: record.$2);
