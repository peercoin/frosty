...
class PublicSharesKeyInfo extends KeyInfo {
  ...
  PublicSharesKeyInfo({required PublicShareList publicShares})
    : list = List.from(publicShares)..sort((a, b) => a.$1.compareTo(b.$1)) {
  ...
  PublicSharesKeyInfo.fromReader(cl.BytesReader reader)
    : this(
