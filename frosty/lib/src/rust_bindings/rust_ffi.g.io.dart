...
class FrostyRustWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_addPtr = _lookup<ffi.NativeFunction<WireSyncReturn Function(ffi.UintPtr, ffi.UintPtr)>>('wire_add');
  late final _wire_add = _wire_addPtr.asFunction<WireSyncReturn Function(int, int)>();
