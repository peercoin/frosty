...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1640352728;
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        11 => wire__crate__api__main__aes_gcm_decrypt_impl(ptr, rust_vec_len, data_len),
        12 => wire__crate__api__main__aes_gcm_encrypt_impl(ptr, rust_vec_len, data_len),
        13 => wire__crate__api__main__aggregate_signature_impl(ptr, rust_vec_len, data_len),
        14 => wire__crate__api__main__dkg_commitment_for_identifier_from_refs_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__main__dkg_part_1_impl(ptr, rust_vec_len, data_len),
        16 => wire__crate__api__main__dkg_part_2_impl(ptr, rust_vec_len, data_len),
        17 => wire__crate__api__main__dkg_part_3_impl(ptr, rust_vec_len, data_len),
        18 => wire__crate__api__main__dkg_round_2_identifier_and_share_from_refs_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__crate__api__main__identifier_and_public_share_from_ref_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__main__identifier_and_signature_share_from_refs_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__main__identifier_and_signing_commitment_from_refs_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__main__identifier_from_bytes_impl(ptr, rust_vec_len, data_len),
        23 => wire__crate__api__main__identifier_from_string_impl(ptr, rust_vec_len, data_len),
        24 => wire__crate__api__main__identifier_from_u16_impl(ptr, rust_vec_len, data_len),
        25 => wire__crate__api__main__identifier_to_bytes_impl(ptr, rust_vec_len, data_len),
        26 => {
            wire__crate__api__main__public_commitment_from_bytes_impl(ptr, rust_vec_len, data_len)
        }
        27 => wire__crate__api__main__public_commitment_to_bytes_impl(ptr, rust_vec_len, data_len),
        28 => wire__crate__api__main__share_to_give_from_bytes_impl(ptr, rust_vec_len, data_len),
        29 => wire__crate__api__main__share_to_give_to_bytes_impl(ptr, rust_vec_len, data_len),
        30 => wire__crate__api__main__sign_part_1_impl(ptr, rust_vec_len, data_len),
        31 => wire__crate__api__main__sign_part_2_impl(ptr, rust_vec_len, data_len),
        32 => wire__crate__api__main__signature_share_from_bytes_impl(ptr, rust_vec_len, data_len),
        33 => wire__crate__api__main__signature_share_to_bytes_impl(ptr, rust_vec_len, data_len),
        34 => {
            wire__crate__api__main__signing_commitment_from_bytes_impl(ptr, rust_vec_len, data_len)
        }
        35 => wire__crate__api__main__signing_commitment_to_bytes_impl(ptr, rust_vec_len, data_len),
        36 => wire__crate__api__main__signing_nonces_from_bytes_impl(ptr, rust_vec_len, data_len),
        37 => wire__crate__api__main__signing_nonces_to_bytes_impl(ptr, rust_vec_len, data_len),
        38 => wire__crate__api__main__verify_signature_share_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
